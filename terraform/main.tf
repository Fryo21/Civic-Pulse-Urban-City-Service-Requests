...
module "function_app" {
  ...
  storage_account_name = module.storage.additional_name

  app_settings = {
    "AzureWebJobsStorage__blobServiceUri"  = "https://${var.storage_additional_name}.blob.core.windows.net"
    "AzureWebJobsStorage__credential"      = "managedidentity"
    "AzureWebJobsStorage__queueServiceUri" = "https://${var.storage_additional_name}.queue.core.windows.net"
    "AzureWebJobsStorage__tableServiceUri" = "https://${var.storage_additional_name}.table.core.windows.net"
